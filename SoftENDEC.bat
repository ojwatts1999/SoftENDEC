...
echo 61: *Severe Weather Statement
echo 62: Shelter In-Place Warning
echo 63: *Special Marine Warning
echo 64: *Special Weather Statement
echo 65: *Storm Surge Warning
echo 66: *Storm Surge Watch
echo 67: *Thunderstorm Warning
echo 68: *Thunderstorm Watch
echo 69: *Tornado Warning
...
cls
echo Current Settings:
echo SAME Header / Alert: Severe Weather Statement
echo Attention Tone: National Weather Service*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
...
echo Sending SAME Header...
title SoftENDEC - Sending SAME
start /wait "C:\Program Files (x86)\VideoLAN\VLC" vlc.exe --audio SEVERE_WEATHER_STATEMENT.wav vlc://quit
cd..
cd attention_tones
title SoftENDEC - Sending Attention Tone (Standard EAS)
echo Sending Standard EAS attention tone...
...
cls
echo Current Settings:
echo SAME Header / Alert: Shelter In-Place Warning
echo Attention Tone: Standard EAS*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
...
cls
echo Current Settings:
echo SAME Header / Alert: Special Marine Warning
echo Attention Tone: National Weather Service*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
...
echo Sending SAME Header...
title SoftENDEC - Sending SAME
start /wait "C:\Program Files (x86)\VideoLAN\VLC" vlc.exe --audio SPECIAL_MARINE_WARNING.wav vlc://quit
cd..
cd attention_tones
title SoftENDEC - Sending Attention Tone (Standard EAS)
echo Sending Standard EAS attention tone...
...
cls
echo Current Settings:
echo SAME Header / Alert: Special Weather Statement
echo Attention Tone: National Weather Service*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
...
echo Sending SAME Header...
title SoftENDEC - Sending SAME
start /wait "C:\Program Files (x86)\VideoLAN\VLC" vlc.exe --audio SPECIAL_WEATHER_STATEMENT.wav vlc://quit
cd..
cd attention_tones
title SoftENDEC - Sending Attention Tone (Standard EAS)
echo Sending Standard EAS attention tone...
...
cls
echo Current Settings:
echo SAME Header / Alert: Storm Surge Warning
echo Attention Tone: National Weather Service*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
...
echo Sending SAME Header...
title SoftENDEC - Sending SAME
start /wait "C:\Program Files (x86)\VideoLAN\VLC" vlc.exe --audio STORM_SURGE_WARNING.wav vlc://quit
cd..
cd attention_tones
title SoftENDEC - Sending Attention Tone (Standard EAS)
echo Sending Standard EAS attention tone...
...
cls
echo Current Settings:
echo SAME Header / Alert: Storm Surge Watch
echo Attention Tone: National Weather Service*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
...
echo Sending SAME Header...
title SoftENDEC - Sending SAME
start /wait "C:\Program Files (x86)\VideoLAN\VLC" vlc.exe --audio STORM_SURGE_WATCH.wav vlc://quit
cd..
cd attention_tones
title SoftENDEC - Sending Attention Tone (Standard EAS)
echo Sending Standard EAS attention tone...
...
cls
echo Current Settings:
echo SAME Header / Alert: Thunderstorm Warning
echo Attention Tone: National Weather Service*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
...
echo Sending SAME Header...
title SoftENDEC - Sending SAME
start /wait "C:\Program Files (x86)\VideoLAN\VLC" vlc.exe --audio THUNDERSTORM_WARNING.wav vlc://quit
cd..
cd attention_tones
title SoftENDEC - Sending Attention Tone (Standard EAS)
echo Sending Standard EAS attention tone...
...
cls
echo Current Settings:
echo SAME Header / Alert: Thunderstorm Watch
echo Attention Tone: National Weather Service*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
...
echo Sending SAME Header...
title SoftENDEC - Sending SAME
start /wait "C:\Program Files (x86)\VideoLAN\VLC" vlc.exe --audio THUNDERSTORM_WATCH.wav vlc://quit
cd..
cd attention_tones
title SoftENDEC - Sending Attention Tone (Standard EAS)
echo Sending Standard EAS attention tone...
...
cls
echo Current Settings:
echo SAME Header / Alert: Tornado Warning
echo Attention Tone: National Weather Service*
echo Voice: VOICE IS SET AS "voice.wav" IN THE "assets" FOLDER (if voice has not been changed since installation, it will match the tones)
echo ---------------------------------------------------------
echo *This cannot be selected by the user.
echo ---------------------------------------------------------
echo Press any key to play.
...
echo Sending SAME Header...
title SoftENDEC - Sending SAME
start /wait "C:\Program Files (x86)\VideoLAN\VLC" vlc.exe --audio TORNADO_WARNING.wav vlc://quit
cd..
cd attention_tones
title SoftENDEC - Sending Attention Tone (Standard EAS)
echo Sending Standard EAS attention tone...
